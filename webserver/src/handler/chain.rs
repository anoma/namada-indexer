...
use crate::response::chain::{
    LastProcessedBlockResponse, LastProcessedEpochResponse, ParametersResponse, RpcUrlResponse, TokenResponse, TokenSupplyResponse
};
...
pub async fn get_rpc_url(State(state): State<CommonState>) -> Json<RpcUrlResponse> {
    Json(RpcUrlResponse {
