...
use crate::entity::governance::{Proposal, ProposalStatus, ProposalType, ProposalVote, TallyType, VoteType};
...
impl Display for ProposalTypeResponse {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ProposalTypeResponse::DefaultWithWasm => write!(f, "default_with_wasm"),
...
impl Display for ProposalStatusResponse {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ProposalStatusResponse::ExecutedPassed => write!(f, "ExecutedPassed"),
            ProposalStatusResponse::ExecutedRejected => write!(f, "ExecutedRejected"),
    ...
    fn from(value: Proposal) -> Self {
        Self {
            ...
            r#type: match value.r#type {
                ...
                ProposalType::DefaultWithWasm => ProposalTypeResponse::DefaultWithWasm,
            ...
            tally_type: match value.tally_type {
                ...
                TallyType::OneHalfOverOneThird => TallyTypeResponse::OneHalfOverOneThird,
                TallyType::LessOneHalfOverOneThirdNay => TallyTypeResponse::LessOneHalfOverOneThirdNay,
            },
            data: value.data,
            ...
            status: match value.status {
                ...
                ProposalStatus::ExecutedPassed => ProposalStatusResponse::ExecutedPassed,
                ProposalStatus::ExecutedRejected => ProposalStatusResponse::ExecutedRejected,
