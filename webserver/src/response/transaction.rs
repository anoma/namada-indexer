...
impl From<TransactionExitStatus> for TransactionResultResponse {
    fn from(value: TransactionExitStatus) -> Self {
        match value {
            TransactionExitStatus::Applied => TransactionResultResponse::Applied,
            TransactionExitStatus::Rejected => TransactionResultResponse::Rejected,
        }
    }
}
    ...
    fn from(value: TransactionHistory) -> Self {
        Self {
            ...
            kind: match value.kind {
                TransactionHistoryKind::Received => TrasactionHistoryKindResponse::Received,
                TransactionHistoryKind::Sent => TrasactionHistoryKindResponse::Sent,
            },
