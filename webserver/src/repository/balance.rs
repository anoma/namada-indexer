...
use diesel::{ExpressionMethods, NullableExpressionMethods, QueryDsl, RunQueryDsl, SelectableHelper};
...
pub trait BalanceRepoTrait {
    ...
    async fn get_all_token(&self) -> Result<Vec<(TokenDb, Option<IbcTokenDb>)>, String>;
    ...
    async fn get_all_token(&self) -> Result<Vec<(TokenDb, Option<IbcTokenDb>)>, String> {
        ...
        conn.interact(|conn| {
            token::table
                ...
                .select((TokenDb::as_select(), Option::<IbcTokenDb>::as_select()))
